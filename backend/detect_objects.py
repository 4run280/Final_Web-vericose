...
if __name__ == "__main__":
	...
	parser.add_argument('--output_directory', help='Path to output images and video', default='C:/Users/alaka/OneDrive/Desktop/MEC/S8/Final_Web-vericose/backend/output')
